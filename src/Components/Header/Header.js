    ...
    return (
        <div className='w-[80%] h-[302px] mx-auto flex justify-between my-[80px]'>
            <div className='w-[486px] mr-8'>
                ...
                <div>
                    <input type="text" placeholder='Enter your Email Id' className='bg-[#F4F2FF] p-2 w-[332px] h-[48px]' />
                    <input type="button" value="Subsribe" className='bg-[#503AE7] text-white w-[154px] px-2 py-3' />
                </div>
            </div>
