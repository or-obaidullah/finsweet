...
const Card = (props) => {
    return (
        <div className="max-w-sm bg-white col-span-1 relative">
            {
            ...
            <div className="">
                ...
                <p className=" font-normal text-[16px] mb-2">Here are the biggest enterprise technology acquisitions of 2021 so far, in reverse chronological order.</p>
                {
                    props.read ?
